...
void D_ConfirmSendStats()
{
	...
	// TODO: texts
	static const char *const MESSAGE_TEXT = "In order to decide where to focus development, the CubeDoom team would like to know a little bit about the hardware it is run on.\n" \
		...
		"It will merely be used for decision-making about CubeDoom's future development.\n" \
	...
	static const char *const TITLE_TEXT = "CubeDoom needs your help!";
